...
<body class="bg-gray-100">
    ...
    <table class="w-[97%] border-collapse border border-black mb-10 mx-auto">
        ...
        <tr class="bg-blue-100 hover:bg-blue-200">
            ...
            <td class="p-2 border border-black text-center"><?=$dt_petugas['username']?></td>
            <td class="p-2 border border-black text-center"><?=$dt_petugas['level']?></td>
            <td class="py-5 border border-black text-center">
                <a href="ubah_petugas.php?id_petugas=<?=$dt_petugas['id_petugas']?>" class="py-2 px-4 bg-green-600 hover:bg-green-700 rounded-lg">Ubah</a> |
                <a href="hapus.php?id_petugas=<?=$dt_petugas['id_petugas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="py-2 px-4 bg-red-600 hover:bg-red-700 rounded-lg">Hapus</a>
            </td>
        </tr>
        <?php 
        }
    ...
    <a href="tambah_petugas.php" class="py-2 px-4 bg-sky-500 hover:bg-sky-600 rounded-lg ml-6">Tambah Petugas</a>
    <?php 
